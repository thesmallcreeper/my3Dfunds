...
public:
	...
	static _Mat3 ChangeView(const Vec3 dir, const Vec3 up)
	{
		Vec3 zAxis = -dir;
		Vec3 xAxis = up % zAxis;
	...
	static _Mat3 ChangeView(const Ved3 dir, const Ved3 up)
	{
		Ved3 zAxis = -dir;
		Ved3 xAxis = up % zAxis;
		Ved3 yAxis = zAxis % xAxis;
		xAxis.Normalize();
		yAxis.Normalize();
		zAxis.Normalize();
...
template<typename T>
Vec3 operator*(const Vec3& lhs, const _Mat3<T>& rhs)
{
	return{
...
template<typename T>
Ved3 operator*(const Ved3& lhs, const _Mat3<T>& rhs)
{
	return{
		lhs.x * rhs.elements[0][0] + lhs.y * rhs.elements[1][0] + lhs.z * rhs.elements[2][0],
		lhs.x * rhs.elements[0][1] + lhs.y * rhs.elements[1][1] + lhs.z * rhs.elements[2][1],
...
template<typename T>
Vec3& operator*=( Vec3& lhs,const _Mat3<T>& rhs )
{
	return lhs = lhs * rhs;
}
template<typename T>
Ved3& operator*=(Ved3& lhs, const _Mat3<T>& rhs)
{
	return lhs = lhs * rhs;
}