...
public:
	CubeSkinFromObjScene(Graphics& gfx, const std::wstring& odjfilename, const std::wstring& imagefilename)
		:
		itlist(AddObjFileModel::GetSkinnedFromObjFile<Vertex>(0.15f, odjfilename)),
		pipeline(gfx),
