...
public:
	...
	virtual void Draw() override
	{
		...
		pipelinedf.effect.ps.BindLightSourceDesnity(110.f);
		pipelinedf.effect.ps.BindAmbientLight(0.3f);
		pipelinedf.effect.ps.BindShininess(3);
		pipelinedf.effect.ps.BindSpecularWeight(1.5f);
		// render triangles
